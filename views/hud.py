...
class Hud:
    def __init__(self, game):
        ...
        self.t_age = OutlinedText("", SCREEN_WIDTH / 2 - 50, top - 46, size=22, anchor_x="left")
    ...
    def draw(self):
        ...
        panel(SCREEN_WIDTH / 2 - 85, SCREEN_WIDTH / 2 + 85, top - 62, top - 12)
        arcade.draw_texture_rect(self.hourglass, arcade.LBWH(SCREEN_WIDTH / 2 - 78, top - 51, 21, 27), pixelated=True)
        ...
        if boss and boss.active and not boss.dead:
            ...
            panel(left - 10, left + w + 10, 18, 60, fill=(30, 10, 30, 220))
